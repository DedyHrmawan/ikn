				...
				<div class="card mb-5 mb-xl-8">
					<div class="card-header border-0 pt-5">
						...
						<div class="card-toolbar">
							<a href="<?= base_url('Welcome/exportDataLatih') ?>" class="btn btn-danger mx-2" title="Download file .arff data latih !"><span class="svg-icon svg-icon-muted svg-icon-2x"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path opacity="0.3" d="M19 15C20.7 15 22 13.7 22 12C22 10.3 20.7 9 19 9C18.9 9 18.9 9 18.8 9C18.9 8.7 19 8.3 19 8C19 6.3 17.7 5 16 5C15.4 5 14.8 5.2 14.3 5.5C13.4 4 11.8 3 10 3C7.2 3 5 5.2 5 8C5 8.3 5 8.7 5.1 9H5C3.3 9 2 10.3 2 12C2 13.7 3.3 15 5 15H19Z" fill="currentColor" />
										<path d="M13 17.4V12C13 11.4 12.6 11 12 11C11.4 11 11 11.4 11 12V17.4H13Z" fill="currentColor" />
										<path opacity="0.3" d="M8 17.4H16L12.7 20.7C12.3 21.1 11.7 21.1 11.3 20.7L8 17.4Z" fill="currentColor" />
									</svg>
								</span>Download .arff</a>
							<a href="#" class="btn btn-primary" title="Proses preprocessing data latih !">Preprocessing
								!</a>
						</div>
					</div>
					<div class="card-body py-3">
						<table class="table table-rounded table-row-bordered table-row-gray-300 align-middle gs-0 gy-3" id="tabelDataLatih">
							<thead>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="mb-3">Edit Data Latih</h3>
			...
			<form id="form-update" action="<?= site_url("dataset/training/update") ?>" method="post">
				<div class="modal-body">
					<div class="d-flex flex-column mb-8 fv-row">
						<label class="d-flex align-items-center fs-6 fw-bold mb-2">
							<span class="required">Tweet / Sentimen</span>
						</label>
						<textarea type="text" readonly class="form-control form-control-solid" name="sentiment" id="sentiment" cols="15" rows="5" required></textarea>
					</div>
					<div class="d-flex flex-column mb-8 fv-row">
						<label class="d-flex align-items-center fs-6 fw-bold mb-2">
...
<div class="modal fade" id="mdlDelDataLatih" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="mb-3">Hapus Data Latih</h3>
			...
			<form id="form-delete" action="<?= site_url("dataset/training/delete") ?>" method="post">
				<div class="modal-body">
					<p>Apakah anda yakin ingin menghapus Data Latih tersebut ?</p>
				</div>
				<div class="modal-footer">
					<input type="hidden" id="" name="">
					<button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
