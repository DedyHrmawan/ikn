			...
			<div class="col-xl-3">
				<span class="card bg-body hoverablecard-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="fw-bold text-gray-400">Sentimen Positif</div>
					</div>
				</span>
			</div>
			<div class="col-xl-3">
				<span class="card bg-dark hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="fw-bold text-gray-100">Sentimen Negatif</div>
					</div>
				</span>
			</div>
			<div class="col-xl-3">
				<span class="card bg-warning hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="fw-bold text-white">Tidak Diketahui</div>
					</div>
				</span>
			</div>
			<div class="col-xl-3">
						...
						<table class="table table-rounded table-row-bordered table-row-gray-300 align-middle gs-0 gy-3"
							...
							<tbody>
								<tr>
									...
									<td class="">
										<a href="" title="Edit Data Latih" data-bs-toggle="modal"
											data-bs-target="#mdlEditDataLatih" data-id=""
											class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mdlEditDataLatih m-1">
										...
										<a href="#" title="Hapus Data Latih" data-bs-toggle="modal"
											data-bs-target="#mdlDelDataLatih" data-id=""
											class="btn btn-icon btn-bg-light btn-active-color-primary mdlDelDataLatih btn-sm m-1">
											<span class="svg-icon svg-icon-3">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
													viewBox="0 0 24 24" fill="none">
													<path
