			...
			<div class="col-xl-3">
				<span class="card bg-success hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="text-white fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['accuracy'] / 3 * 100, 2) ?>%</div>
			...
			<div class="col-xl-3">
				<span class="card bg-warning hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="text-white fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['recall'] / 3 * 100, 2) ?>%</div>
			...
			<div class="col-xl-3">
				<a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
					<div class="card-body">
						...
						<div class="text-white fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['f_measure'] / 3 * 100, 2) ?>%</div>
