			...
			<div class="col-xl-3">
				<span class="card bg-gray-300 hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['precision'] / 3 * 100, 2) ?>%</div>
			...
			<div class="col-xl-3">
				<span class="card bg-success hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['accuracy'] / 3 * 100, 2) ?>%</div>
			...
			<div class="col-xl-3">
				<span class="card bg-warning hoverable card-xl-stretch mb-xl-8">
					<div class="card-body">
						...
						<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['recall'] / 3 * 100, 2) ?>%</div>
			...
			<div class="col-xl-3">
				<a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
					<div class="card-body">
						...
						<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?= number_format($statistics['f_measure'] / 3 * 100, 2) ?>%</div>
			...
			<div class="col">
				<div class="card mb-5 mb-xl-8">
					...
					<div class="card-body py-3">
						<table class="table table-rounded table-row-bordered table-row-gray-300 align-middle gs-0 gy-3" id="tabelCMatrix">
							<thead>
							...
							<tbody>
								<?php foreach ($results as $item) { ?>
									<tr>
										...
										<td class="text-dark fw-bolder text-hover-primary fs-6">
											<?= $item->precision_value * 100 ?>%
										</td>
										<td class="text-dark fw-bolder text-hover-primary fs-6">
											<?= $item->accuracy_value * 100 ?>%
										</td>
										<td class="text-dark fw-bolder text-hover-primary fs-6">
											<?= $item->recall_value * 100 ?>%
										</td>
										<td class="text-dark fw-bolder text-hover-primary fs-6">
											<?= $item->f_measure_value * 100 ?>%
										</td>
									</tr>
								<?php } ?>
							</tbody>
